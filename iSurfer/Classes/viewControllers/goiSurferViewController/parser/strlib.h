 ...
 * "ABCDE".
 * @method Concat
 * @param s1 {char *} pointer to left part.
 * @param s2 {char *} pointer with what to concat.
 * @return {char *} a new string with the result.
 */
 ...
 * @param i {int} char index.
 * @return {char } the character at position i.
 */
 ...
 * @method SubString
 * @param s {char *} pointer to string.
 * @param p1 {int} start index.
 * @param p2 {int} end index.
 * @return {char *} a new string with the result.
 */
 ...
 * @method CharToString
 * @param ch {char} pointer to string.
 * @return {char *} a new string with the result.
 */
 ...
 * @method CopyString
 * @param s {char *} pointer to string.
 * @return {char *} a copy of the string.
 */
 ...
 * @method StringEqual
 * @param s1 {char *} pointer to string 1.
 * @param s1 {char *} pointer to string 2.
 * @return {Boolean}.
 */
 ...
 * found.
 * @method FindChar
 * @param ch {char} char to search.
 * @param text {char *} pointer to string.
 * @param start {int} position to start searching.
 * @return {int} the first index at which ch appears or -1 if no match is found.
 */
 ...
 * found.
 * @method FindString
 * @param str {const char *} pointer to string to find.
 * @param text {char *} pointer to string.
 * @param start {int} position to start searching.
 * @return {int} the first index at which ch appears or -1 if no match is found.
 */
 ...
 * @param s {char *} pointer to string.
 * @return {int} with the number in the string.
 */
 ...
 * @method StringToReal
 * @param s {char *} pointer to string.
 * @return {double} with the number in the string.
 */
